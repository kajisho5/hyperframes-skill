...
export function buildContract() {
  return {
    ...
    skill: {
      ...
      not_provided: ["AI reasoning", "creative or compositional decisions", "scene content (copy, pacing, asset choice)", "network access", "cloud rendering", "loudness normalisation, ducking and audio mixing controls (layer gain and fades only)", "free-form animation (only fade / slide / zoom layer transitions)"],
    },
