...
export function buildContract() {
  return {
    ...
    skill: {
      ...
      kind: "execution",
      entrypoints: { cli: "bin/hyperframes-skill.mjs <tool> [args]", scripts: "scripts/<tool>.mjs", contract: "bin/hyperframes-skill.mjs contract --json", doctor: "scripts/doctor.mjs --json" },
      not_provided: ["AI reasoning", "creative or compositional decisions", "scene content (copy, pacing, asset choice)", "network access", "cloud rendering", "audio mixing (later theme)", "animation (later theme)"],
    },
