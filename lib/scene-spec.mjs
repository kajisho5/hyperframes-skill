...
const LAYER_KEYS = {
  text: new Set(["type", "id", "start", "duration", "box", "text", "style"]),
  image: new Set(["type", "id", "start", "duration", "box", "src", "fit"]),
  video: new Set(["type", "id", "start", "duration", "box", "src", "fit", "media_start"]),
};
